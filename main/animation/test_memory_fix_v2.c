...
static const char* TAG = "test_memory_fix_v2";

void test_memory_fix_v2(void)
{
    ESP_LOGI(TAG, "=== Testing Memory Fix V2 ===");
    ...
    ESP_LOGI(TAG, "=== Memory Fix V2 Test Complete - No Crashes! ===");
}
