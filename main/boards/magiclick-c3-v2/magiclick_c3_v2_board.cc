...
LV_FONT_DECLARE(font_puhui_14_1);  // Changed from 16_4 to 14_1 for smaller size
LV_FONT_DECLARE(font_awesome_14_1); // Changed from 16_4 to 14_1 for smaller size
...
public:
    GC9107Display(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
        ...
        : SpiLcdDisplay(panel_io, panel, width, height, offset_x, offset_y, mirror_x, mirror_y, swap_xy, 
                    {
                        .text_font = &font_puhui_14_1,  // OPTIMIZED: Smaller font for Chinese Mandarin
                        .icon_font = &font_awesome_14_1, // OPTIMIZED: Smaller icon font
