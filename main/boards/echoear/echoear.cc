...
#include "touch.h"
#if __has_include(<touch_sensor_lowlevel.h>) && __has_include(<touch_button_sensor.h>)
#include <touch_sensor_lowlevel.h>
#include <touch_button_sensor.h>
#define ECHOEAR_HAS_TOUCH_BUTTON 1
#else
#define ECHOEAR_HAS_TOUCH_BUTTON 0
#endif
...
// BMI270 includes
#if __has_include("bmi270_api.h") && __has_include("i2c_bus.h")
#include "bmi270_api.h"
#include "i2c_bus.h"
#include <esp_idf_version.h>
#define ECHOEAR_HAS_BMI270 1
#else
#define ECHOEAR_HAS_BMI270 0
#endif
...
private:
    ...
    void InitializeI2c() {
        ...
        #else
        // Fallback: initialize standard I2C master bus for other devices
        ...
        ESP_LOGW(TAG, "[BMI270] i2c_bus wrapper not available; BMI270 disabled, I2C master bus ready");
        #endif
    ...
    void InitializeTouchButton()
    {
        ESP_LOGW(TAG, "[TOUCH] touch_sensor_lowlevel.h not available; touch button disabled");
    }
    #endif
    ...
    void InitializeBmi270() {
        ...
        #else
        ESP_LOGW(TAG, "[BMI270] bmi270_api.h not available; BMI270 disabled");
        #endif
    }
