...
// OPTIMIZED: Use smaller font sizes for Chinese Mandarin to reduce memory usage
LV_FONT_DECLARE(font_puhui_16_4);  // Changed from 30_4 to 16_4 for significantly smaller size
LV_FONT_DECLARE(font_awesome_16_4); // Changed from 20_4 to 16_4 for smaller size
    ...
    public:
        CustomLcdDisplay(esp_lcd_panel_io_handle_t io_handle, 
            ...
            : SpiLcdDisplay(io_handle, panel_handle, width, height, offset_x, offset_y, mirror_x, mirror_y, swap_xy,
                    {
                        .text_font = &font_puhui_16_4,  // OPTIMIZED: Much smaller font for Chinese Mandarin
                        .icon_font = &font_awesome_16_4, // OPTIMIZED: Smaller icon font
